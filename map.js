...
var app = new Vue({
    ...
    mounted() {
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const initialLat = queryParams.lat ?? 13.7854775; // original is 0
            const initialLng = queryParams.lng ?? 101.6968661; // original is 0
            const initialZoom = queryParams.zoom ?? 6;
